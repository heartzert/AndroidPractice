package heartzert.test.all.samples.contentprovider
...
class TestProviderActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val bookUri = Uri.parse("content://heartzert.test.all.templates.contentprovider.TestProvider/book")
        val userUri = Uri.parse("content://heartzert.test.all.templates.contentprovider.TestProvider/user")
