package heartzert.test.all.templates.viewpager_fragment.ui.main
...
abstract class BaseFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        super.onViewCreated((if (isReuseView) rootView else view) ?: return, savedInstanceState)
    }
    ...
    protected open fun onFragmentVisibleChange(isVisible: Boolean) {
        Log.d("========", "$TAG + onFragmentVisibleChange")
