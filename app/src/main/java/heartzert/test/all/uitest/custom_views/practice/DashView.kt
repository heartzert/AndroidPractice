...
class DashView : View {
    ...
    private var shader = SweepGradient(
        0f, 0f, Color.parseColor("#FF00FF"),
        Color.parseColor("#FFFF00")
    ).apply { setLocalMatrix(Matrix().apply { setRotate(90f) }) }
    ...
    init {
        ...
        pathEffect = PathDashPathEffect(
            dash, ((measure.length - DASH_WIDTH)) / 20, 0f,
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        //画边框
        canvas.drawRect(
            -RADIUS - paint.strokeWidth / 2, -RADIUS - paint.strokeWidth / 2,
